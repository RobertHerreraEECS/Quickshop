...
class SwitchingViewController: UIViewController{
    ...
    private var itemViewController: ItemListViewController!
    ...
    override func viewDidLoad() {
        ...
        ShoppingList.sharedInstance.readSaveData()
    ...
    override func didReceiveMemoryWarning() {
        ...
        else if itemViewController != nil && itemViewController!.view.superview == nil {
    ...
    @IBAction func switchViews(sender: UIButton) {
        ...
        if itemViewController?.view.superview == nil {
            if itemViewController == nil {
                itemViewController = storyboard?.instantiateViewControllerWithIdentifier("ShoppingList")
        ...
        if blueViewController != nil && blueViewController!.view.superview != nil {
            ...
            if sender.titleLabel!.text == "Build My Shopping List"{
            ...
            else if sender.titleLabel!.text == "My List"{
                ...
                myList.hidden = true
                ButtonLabel2.hidden = false
                switchViewController3(from: blueViewController, to: itemViewController)
            }
            ...
            if sender.titleLabel!.text == "Home"  &&  itemViewController.view.frame == tempStatus{
                ButtonLabel1.hidden = false
                ButtonLabel3.hidden = false
                myList.hidden = false
                ButtonLabel2.hidden = true
                //switchViewController(from: navViewController2, to: blueViewController)
                switchViewController3(from: itemViewController, to: blueViewController)
            }
        }
    ...
    private func switchViewController3(from fromVC:UIViewController?, to toVC:UIViewController?) {
        if fromVC != nil {
            fromVC!.willMoveToParentViewController(nil)
            fromVC!.view.removeFromSuperview()
            fromVC!.removeFromParentViewController()
